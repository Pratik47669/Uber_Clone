...
const CaptainSignup = () => {
  ...
  // }
  return (
    <div className='py-3 px-4 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={(e) => {
          ...
          <div className='flex gap-4 mb-5'>
            <input
              required
              className='bg-[#eeeeee] w-40 rounded-lg px-4 py-2 border text-lg placeholder:text-base'
              type="number"
            ...
            <select
              required
              className='bg-[#eeeeee] w-80 rounded-lg border text-lg placeholder:text-base'
              value={vehicleType}
              onChange={(e) => {
